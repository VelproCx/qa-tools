def parse_fix_message(message):
    fix_tags = {
        ...
        "8164": "CrossingPriceType  ",
        "8214": "MarginTransactionType",
        "9172": "FsxBboPrice"
    }

    tags = {}
    tag_value_pairs = message.split('|')
    for tag_value_pair in tag_value_pairs:
        tag_value = tag_value_pair.split('=')
        if len(tag_value) == 2:
            tag = tag_value[0]
            value = tag_value[1]
            tags[tag] = value
    ...
    for tag, value in tags.items():
        if tag in fix_tags:
            tag_name = fix_tags[tag]
            parsed_tags[tag_name] = value

    return parsed_tags


# fix_message = "8=FIX.4.2|9=598|35=8|34=75|49=FSX_UAT_EDP|52=20230730-04:23:11.212|56=RUAT_EDP_2|1=firms/Clear-Member/accounts/RUAT_EDP_ACCOUNT_2|6=31020|11=018230730132309000063|14=100|17=50207301249240000519|19=1685506292635992066|20=2|31=3102|32=100|37=1685506292618047488|38=100|39=2|40=2|44=3625|47=P|54=1|55=1925|59=0|60=20230730-04:23:11.212|76=EDP|109=102|110=0|150=2|151=0|198=10207301249180000517|375=12057|527=1685506292635992066|544=1|851=1|8031=3879|8032=3879|8033=3879|8051=3879|8060=4|8101=1230730042311000015|8102=4202307306112000022|8106=20230730-04:23:11.200|8164=EDP|8169=20230730-04:23:11.212744|8174=0|8214=20230730 13:23:11.213129"
# parsed_tags = parse_fix_message(fix_message)
# for tag_name, value in parsed_tags.items():
