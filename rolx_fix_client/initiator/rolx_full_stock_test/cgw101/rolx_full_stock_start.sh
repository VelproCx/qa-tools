...
python3 /Users/zhenghuaimao/Desktop/qa-tools/rolx_fix_client/initiator/rolx_full_stock_test/cgw101/rolx_full_stock_application.py --account RSIT_ACCOUNT_7 --Sender RSIT_ROLX_7 --Target FSX_SIT_ROLX --Host 35.74.32.240 --Port 5001
