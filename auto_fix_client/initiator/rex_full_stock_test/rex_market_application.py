...
# report
setup_logger('logfix', 'logs/rex_price_report.log')
...
class Application(fix.Application):
    ...
    Total = 0
    sideNum = 0
    REX_PROP_BPS_BUY = 0.0010
    REX_PROP_BPS_SELL = 0.0040
    def __init__(self):
        super().__init__()
        self.sessionID = None
    ...
    def onLogout(self, sessionID):
        ...
        # send_mail(['logs/rex_price_report.log'])
        return
                ...
                if adjustLastPx == lastPx:
                    ...
                    logfix.info(
                        'Market Price is not matching,' + 'clOrdID：' + clOrdID + ',' + 'symbol：' + symbol + ',' + 'adjustLastPx：' + str(
                            adjustLastPx) + ',' + 'lastPx:' + str(lastPx) + ',' + clOrdID)
            elif side == "2":
    ...
    def insert_order_request(self, row):
        ...
        msg.setField(fix.Account("RUAT_ACCOUNT_2"))
